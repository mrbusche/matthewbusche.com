...
hljs.registerLanguage('nsis', function (a) {
	...
	var b = { cN: 'constant', b: '\\$+{[a-zA-Z0-9_]+}' };
	var f = { cN: 'variable', b: '\\$+[a-zA-Z0-9_]+', i: '\\(\\){}' };
	var e = { cN: 'constant', b: '\\$+\\([a-zA-Z0-9_]+\\)' };
	var g = {
		cN: 'params',
	...
	return {
		...
		c: [
			...
			a.CLCM,
			{
				...
				e: /\{/,
				i: /\n/,
				c: [a.inherit(a.TM, { starts: { eW: true, eE: true } })],
			},
			{ cN: 'function', bK: 'rpc', e: /;/, eE: true, k: 'rpc returns' },
			{ cN: 'constant', b: /^\s*[A-Z_]+/, e: /\s*=/, eE: true },
		],
	};
});
...
hljs.registerLanguage('ruby', function (f) {
	...
	var h = [
		...
		},
		{
			...
			e: ' |$|;',
			r: 0,
			c: [f.inherit(f.TM, { b: j }), a, k],
		},
		{ cN: 'constant', b: '(::)?(\\b[A-Z]\\w*(::)?)+', r: 0 },
		{ cN: 'symbol', b: f.UIR + '(\\!|\\?)?:', r: 0 },
		{ cN: 'symbol', b: ':', c: [e, { b: j }], r: 0 },
		{
			cN: 'number',
...
hljs.registerLanguage('rust', function (a) {
	return {
		...
		k: {
			...
			built_in:
				'assert! assert_eq! bitflags! bytes! cfg! col! concat! concat_idents! debug_assert! debug_assert_eq! env! fail! file! format! format_args! include_bin! include_str! line! local_data_key! module_path! option_env! print! println! select! stringify! try! unimplemented! unreachable! vec! write! writeln!',
		},
		l: a.IR + '!?',
		i: '</',
		c: [
			...
			{ cN: 'function', bK: 'fn', e: '(\\(|<)', eE: true, c: [a.UTM] },
			{ cN: 'preprocessor', b: '#\\[', e: '\\]' },
			{ bK: 'type', e: '(=|<)', c: [a.UTM], i: '\\S' },
			{ bK: 'trait enum', e: '({|<)', c: [a.UTM], i: '\\S' },
			{ b: a.IR + '::' },
			{ b: '->' },
		],
	};
...
hljs.registerLanguage('ruleslanguage', function (a) {
	return {
		...
		c: [a.CLCM, a.CBCM, a.ASM, a.QSM, a.CNM, { cN: 'array', b: '#[a-zA-Z .]+' }],
	};
});
	...
	return {
		...
		c: [
			...
			},
			{
				...
				e: /\{/,
				eE: true,
				c: [a.inherit(a.TM, { b: /[A-Za-z$_][0-9A-Za-z$_]*/ }), { cN: 'params', b: /\(/, e: /\)/, c: [a.CLCM, a.CBCM], i: /["'\(]/ }],
				i: /\[|%/,
			},
			{ b: /\$[(.]/ },
			{ b: '\\.' + a.IR, r: 0 },
...
hljs.registerLanguage('glsl', function (a) {
	return {
		...
		i: '"',
		c: [a.CLCM, a.CBCM, a.CNM, { cN: 'preprocessor', b: '#', e: '$' }],
	};
});
...
hljs.registerLanguage('gcode', function (a) {
	...
	var b = { cN: 'preprocessor', b: '([O])([0-9]+)' };
	var d = [
		a.CLCM,
		{ cN: 'comment', b: /\(/, e: /\)/, c: [a.PWM] },
		a.CBCM,
		a.inherit(a.CNM, { b: '([-+]?([0-9]*\\.?[0-9]+\\.?))|' + a.CNR }),
	...
	return {
		...
		l: e,
		k: c,
		c: [{ cN: 'preprocessor', b: f }, b].concat(d),
	};
});
						...
						c: [
							{
								...
								starts: {
									...
									eW: true,
									eE: true,
									c: [c, a.CSSNM, a.QSM, a.ASM, a.CBCM, { cN: 'hexcolor', b: '#[0-9A-Fa-f]+' }, { cN: 'important', b: '!important' }],
								},
							},
						],
					},
...
hljs.registerLanguage('lisp', function (i) {
	...
	var h = i.inherit(i.QSM, { i: null });
	var n = { cN: 'comment', b: ';', e: '$', r: 0 };
	var g = { cN: 'variable', b: '\\*', e: '\\*' };
	var o = { cN: 'keyword', b: '[:&]' + l };
	var d = { b: '\\(', e: '\\)', c: ['self', b, h, e] };
	var a = {
		cN: 'quoted',
		c: [e, h, g, o, d],
		v: [
	...
	var j = { cN: 'list', b: '\\(', e: '\\)' };
	var f = { eW: true, r: 0 };
	j.c = [{ cN: 'keyword', b: l }, f];
	f.c = [a, c, j, b, e, h, n, g, o];
	return { i: /\S/, c: [e, k, b, h, n, a, c, j] };
});
...
hljs.registerLanguage('fsharp', function (a) {
	...
	return {
		...
		c: [
			...
			{ cN: 'string', b: '"""', e: '"""' },
			{ cN: 'comment', b: '\\(\\*', e: '\\*\\)' },
			{ cN: 'class', bK: 'type', e: '\\(|=|$', eE: true, c: [a.UTM, b] },
...
hljs.registerLanguage('swift', function (a) {
	...
	var g = { cN: 'type', b: "\\b[A-Z][\\w']*", r: 0 };
	var b = { cN: 'comment', b: '/\\*', e: '\\*/', c: [a.PWM, 'self'] };
	var c = { cN: 'subst', b: /\\\(/, e: '\\)', k: e, c: [] };
	var f = {
		cN: 'number',
		b: '\\b([\\d_]+(\\.[\\deE_]+)?|0x[a-fA-F0-9_]+(\\.[a-fA-F0-9p_]+)?|0b[01_]+|0o[0-7_]+)\\b',
		r: 0,
	};
	var d = a.inherit(a.QSM, { c: [c, a.BE] });
	c.c = [f];
	return {
		k: e,
		c: [
			...
			f,
			{
				...
				eE: true,
				c: [
					a.inherit(a.TM, { b: /[A-Za-z$_][0-9A-Za-z$_]*/, i: /\(/ }),
					{ cN: 'generics', b: /\</, e: /\>/, i: /\>/ },
					{
						cN: 'params',
						b: /\(/,
...
hljs.registerLanguage('scheme', function (k) {
	...
	var n = { cN: 'shebang', b: '^#!', e: '$' };
	var f = { cN: 'literal', b: '(#t|#f|#\\\\' + m + '|#\\\\.)' };
	var g = {
		cN: 'number',
		v: [{ b: d, r: 0 }, { b: h, r: 0 }, { b: '#b[0-1]+(/[0-1]+)?' }, { b: '#o[0-7]+(/[0-7]+)?' }, { b: '#x[0-9a-f]+(/[0-9a-f]+)?' }],
	};
	var j = k.QSM;
	var b = { cN: 'regexp', b: '#[pr]x"', e: '[^\\\\]"' };
	var o = {
		cN: 'comment',
		v: [
			{ b: ';', e: '$', r: 0 },
	...
	var l = {
		...
		c: [{ cN: 'keyword', b: m, l: m, k: e }, i],
	};
	i.c = [f, g, j, o, c, a, l];
	return { i: /\S/, c: [n, g, j, o, a, l] };
});
...
hljs.registerLanguage('nix', function (b) {
	...
	var g = { cN: 'subst', b: /\$\{/, e: /\}/, k: a };
	var d = { cN: 'variable', b: /[a-zA-Z0-9-_]+(\s*=)/ };
	var e = { cN: 'string', b: "''", e: "''", c: [g] };
	var f = { cN: 'string', b: '"', e: '"', c: [g] };
	var c = [b.NM, b.HCM, b.CBCM, e, f, d];
	g.c = c;
	return { aliases: ['nixos'], k: a, c: c };
});
...
hljs.registerLanguage('scala', function (d) {
	var b = { cN: 'annotation', b: '@[A-Za-z]+' };
	var c = { cN: 'string', b: 'u?r?"""', e: '"""', r: 10 };
	var a = { cN: 'symbol', b: "'\\w[\\w\\d_]*(?!')" };
	var e = { cN: 'type', b: '\\b[A-Z][A-Za-z0-9_]*', r: 0 };
	var h = {
		cN: 'title',
		b: /[^0-9\n\t "'(),.`{}\[\]:;][^\n\t "'(),.`{}\[\]:;]+|[^0-9\n\t "'(),.`{}\[\]:;=]/,
		r: 0,
	...
	var i = {
		...
		e: /[:={\[(\n;]/,
		c: [{ cN: 'keyword', bK: 'extends with', r: 10 }, h],
	};
	var g = { cN: 'function', bK: 'def val', e: /[:={\[(\n;]/, c: [h] };
	var f = {
		cN: 'javadoc',
		b: '/\\*\\*',
		e: '\\*/',
...
hljs.registerLanguage('ocaml', function (a) {
	return {
		...
		c: [
			...
			{ cN: 'class', bK: 'type', e: '\\(|=|$', eE: true, c: [a.UTM] },
			{ cN: 'annotation', b: '\\[<', e: '>\\]' },
			a.CBCM,
			a.inherit(a.ASM, { i: null }),
			a.inherit(a.QSM, { i: null }),
...
hljs.registerLanguage('nginx', function (c) {
	...
	var a = {
		...
		c: [
			...
			{ cN: 'url', b: '([a-z]+):/', e: '\\s', eW: true, eE: true, c: [b] },
			{
				cN: 'regexp',
				c: [c.BE, b],
				v: [
...
hljs.registerLanguage('dos', function (a) {
	var c = { cN: 'comment', b: /@?rem\b/, e: /$/, r: 10 };
	var b = {
		cN: 'label',
		b: '^\\s*[A-Za-z._?][A-Za-z0-9_$#@~.?]*(:|\\s+label)',
		r: 0,
		...
		c: [
			...
			{ cN: 'tag', b: '</?', e: '>' },
			{
				...
				starts: {
					...
					c: [{ cN: 'sqbracket', b: '\\s\\[', e: '\\]$' }, { cN: 'cbracket', b: '[\\$%]\\{', e: '\\}', c: ['self', b] }, b, a.QSM],
				},
			},
		],
		i: /\S/,
...
hljs.registerLanguage('scss', function (a) {
	var c = '[a-zA-Z-][a-zA-Z0-9_-]*';
	var f = { cN: 'variable', b: '(\\$' + c + ')\\b' };
	var d = { cN: 'function', b: c + '\\(', rB: true, eE: true, e: '\\(' };
	...
	var e = {
		...
		starts: {
			...
			eW: true,
			eE: true,
			c: [d, b, a.CSSNM, a.QSM, a.ASM, a.CBCM, { cN: 'important', b: '!important' }],
		},
	};
	return {
		cI: true,
		...
		c: [
			...
			},
			{
				...
				b: ':',
				e: ';',
				c: [d, f, b, a.CSSNM, a.QSM, a.ASM, { cN: 'important', b: '!important' }],
			},
			{
				cN: 'at_rule',
				b: '@',
				...
				c: [d, f, a.QSM, a.ASM, b, a.CSSNM, { cN: 'preprocessor', b: '\\s[A-Za-z0-9_.-]+', r: 0 }],
			},
		],
	};
});
hljs.registerLanguage('monkey', function (a) {
	var b = { v: [{ cN: 'number', b: '[$][a-fA-F0-9]+' }, a.NM] };
	return {
		cI: true,
		k: {
			keyword:
...
hljs.registerLanguage('clojure', function (j) {
	...
	var i = j.inherit(j.QSM, { i: null });
	var n = { cN: 'comment', b: ';', e: '$', r: 0 };
	var m = { cN: 'collection', b: '[\\[\\{]', e: '[\\]\\}]' };
	var c = { cN: 'comment', b: '\\^' + f };
	var b = { cN: 'comment', b: '\\^\\{', e: '\\}' };
	var h = { cN: 'attribute', b: '[:]' + f };
	var l = { cN: 'list', b: '\\(', e: '\\)' };
	var g = { eW: true, k: { literal: 'true false nil' }, r: 0 };
	var o = { k: e, l: f, cN: 'keyword', b: f, starts: g };
	l.c = [{ cN: 'comment', b: 'comment' }, o, g];
	g.c = [l, i, c, b, n, h, m, d];
	m.c = [l, i, c, n, h, m, d];
	return {
		aliases: ['clj'],
		i: /\S/,
		c: [n, l, { cN: 'prompt', b: /^=> /, starts: { e: /\n\n|\Z/ } }],
	};
});
hljs.registerLanguage('elixir', function (e) {
	...
	var b = { eW: true, rE: true, l: f, k: i, r: 0 };
	var h = {
		cN: 'function',
		bK: 'def defmacro',
		e: /\bdo\b/,
		c: [e.inherit(e.TM, { b: g, starts: b })],
	};
	var j = e.inherit(h, {
		cN: 'class',
...
hljs.registerLanguage('typescript', function (a) {
	return {
		...
		k: {
			keyword:
				'in if for while finally var new function|0 do return void else break catch instanceof with throw case default try this switch continue typeof delete let yield const class public private get set super interface extendsstatic constructor implements enum export import declare',
			literal: 'true false null undefined NaN Infinity',
			built_in:
		...
		c: [
			...
			{ cN: 'constructor', bK: 'constructor', e: /\{/, eE: true, r: 10 },
			{ cN: 'module', bK: 'module', e: /\{/, eE: true },
			{ cN: 'interface', bK: 'interface', e: /\{/, eE: true },
			{ b: /\$[(.]/ },
			{ b: '\\.' + a.IR, r: 0 },
		],
	};
